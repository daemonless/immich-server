...
ARG PACKAGES="node22 vips ffmpeg p5-Image-ExifTool libheif libraw webp alsa-lib sndio sekrit-twc-zimg libopenmpt chromaprint libzvbi fdk-aac libtheora postgresql18-client libva-intel-media-driver mesa-dri libva-utils gzip"
ARG UPSTREAM_URL="https://api.github.com/repos/immich-app/immich/releases/latest"
